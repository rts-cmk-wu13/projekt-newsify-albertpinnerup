...
<path d="M19 21L12 16L5 21V5C5 4.46957 5.21071 3.96086 5.58579 3.58579C5.96086 3.21071 6.46957 3 7 3H17C17.5304 3 18.0391 3.21071 18.4142 3.58579C18.7893 3.96086 19 4.46957 19 5V21Z" stroke="#D9D9D9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
        `
        ...
        function move(e) {
            ...
            if (movedX < 0) {
                ...
                e.target.closest(".article__content").style.left = movedX + "px"
            }

            if (movedX < -100) {
                e.target.closest(".article__card").append(icon)
                e.target.closest(".article__card").querySelector(".article__bookmark").classList.add("save")
            }
        ...
        function up(e) {
            ...
            if (movedX < -100) {
                ...
                const alreadySaved = saved.some(article => article.slug_name === parsed.slug_name);
...
export function swiperDelete() {
    ...
    container.forEach(article => {
        ...
        document.querySelector(".article__card").classList.add("delete")
        ...
        function move(e) {
            ...
            if (movedX < -100) {
                e.target.closest(".article__card").append(icon)
                e.target.closest(".article__card").querySelector(".article__delete").classList.add("delete")
            }
        ...
        function up(e) {
            ...
            if (movedX < -100) {
                ...
                if (remaining <= 1) {
                    // if this was the last card, remove the entire section
                    wrapper.remove();
                } else {
                    // otherwise just remove the one card
                    card.remove();
                }
            }
        }
